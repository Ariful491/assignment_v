        ...
        <div class="py-12">
            ...
            <div class="mt-4">
                <InputLabel for="type" value="Product Type" />
                 <input type="radio" name="type" class="mr-3 w-6 h-6 rounded-lg"  v-model="form.type"  @change="formTypeCheck()" value="1" for="solid" />
            ...
            <div class="mt-4">
                ...
                <img v-if="form.photo" :src="form.photo" class="w-48" >
